...
namespace TransportathonHackathon.Persistence.Migrations
{
    ...
    [Migration("20230917135658_Mig_2")]
    partial class Mig_2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TransportathonHackathon.Domain.Entities.Identity.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("aec43206-3a6e-4bff-8b21-1dd5104a3344"),
                            ConcurrencyStamp = "9742f893-3467-4308-bf60-9dc119f95be9",
                            Name = "Admin",
            ...
            modelBuilder.Entity("TransportathonHackathon.Domain.Entities.Identity.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("070dc8af-ad63-4c67-ba7c-481c9bee6fed"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "c6f8a595-d4fe-4199-8216-50d114c183aa",
                            CreatedDate = new DateTime(2023, 9, 17, 16, 56, 58, 441, DateTimeKind.Local).AddTicks(1423),
                            Email = "admin@admin.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@ADMIN.COM",
                            NormalizedUserName = "ADMIN",
                            PasswordHash = "AQAAAAIAAYagAAAAEIzdyT6vzRpJ81WBoJiSgTDJ9ums10cKgyRDe/rWjw7Azty0dyu6aws4EInXwcUs6g==",
                            PhoneNumberConfirmed = true,
                            TwoFactorEnabled = false,
                            UpdatedDate = new DateTime(2023, 9, 17, 16, 56, 58, 441, DateTimeKind.Local).AddTicks(1433),
                            UserName = "admin"
                        });
                });
            ...
            modelBuilder.Entity("TransportathonHackathon.Domain.Entities.Identity.AppUserClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ClaimType = "UserType",
                            ClaimValue = "Admin",
                            UserId = new Guid("070dc8af-ad63-4c67-ba7c-481c9bee6fed")
                        });
                });
            ...
            modelBuilder.Entity("TransportathonHackathon.Domain.Entities.Identity.AppUserRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = new Guid("070dc8af-ad63-4c67-ba7c-481c9bee6fed"),
                            RoleId = new Guid("aec43206-3a6e-4bff-8b21-1dd5104a3344")
                        });
                });
            ...
            modelBuilder.Entity("TransportathonHackathon.Domain.Entities.TransportRequest", b =>
                {
                    ...
                    b.HasOne("TransportathonHackathon.Domain.Entities.TransportType", "TransportType")
                        .WithMany("TransportRequests")
